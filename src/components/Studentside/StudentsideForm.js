...
function StudentsideForm() {
    ...
    return (
        <>
            ...
            <Header/>
            <Box sx={{ display: 'grid',margin:'1.3rem 0.7rem',alignItems: 'center',justifyContent: 'center',backgroundColor: 'black',color: 'white',fontSize: '1.3rem',padding:'0.5rem',borderRadius: '5px'}}>Complaint-Form</Box>
                <Box sx={{minHeight:'100vh',display:'flex',margin:'2vh 2rem',flexDirection:'column'}}>
                    ...
                    <TextField id="outlined-disabled" InputLabelProps={{ shrink: true}} onChange={handleChangesss('description')} label="Description" value={feedback.description} style={{ marginBottom: "1rem" }} fullWidth/>
                    <Button variant="contained" size="medium" sx={{  margin: "1vh auto",backgroundColor:'black'}} onClick={postComplain}>Post</Button>
                </Box>
            <Footer/>
        </>
    )
